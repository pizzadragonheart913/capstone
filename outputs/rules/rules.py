def findDecision(obj): #obj[0]: CRIM, obj[1]: ZN, obj[2]: INDUS, obj[3]: CHAS, obj[4]: NOX, obj[5]: RM, obj[6]: AGE, obj[7]: DIS, obj[8]: RAD, obj[9]: TAX, obj[10]: PTRATIO, obj[11]: B, obj[12]: LSTAT, obj[13]: CAT. MEDV
	# {"feature": "CAT. MEDV", "instances": 504, "metric_value": 3.6015, "depth": 1}
	if obj[13]<=0:
		# {"feature": "LSTAT", "instances": 420, "metric_value": 1.5436, "depth": 2}
		if obj[12]<=14.181904761904761:
			# {"feature": "RM", "instances": 238, "metric_value": 0.3579, "depth": 3}
			if obj[5]>6.217747899159664:
				# {"feature": "PTRATIO", "instances": 120, "metric_value": 0.2556, "depth": 4}
				if obj[10]<=20.054002398079902:
				...
				elif obj[10]>20.054002398079902:
					# {"feature": "AGE", "instances": 27, "metric_value": 0.4141, "depth": 5}
					if obj[6]>80.32962962962964:
						# {"feature": "CRIM", "instances": 16, "metric_value": 0.5426, "depth": 6}
						if obj[0]<=14.3337:
							# {"feature": "DIS", "instances": 15, "metric_value": 0.4054, "depth": 7}
							if obj[7]<=2.5182:
								# {"feature": "B", "instances": 9, "metric_value": 0.3032, "depth": 8}
								if obj[11]<=391.34:
									# {"feature": "CHAS", "instances": 5, "metric_value": 0.3924, "depth": 9}
									if obj[3]<=0:
										return 23.133333333333336
									elif obj[3]>0:
										return 21.799999999999997
									else: return 21.799999999999997
								elif obj[11]>391.34:
									return 20.625
								else: return 20.625
							elif obj[7]>2.5182:
				...
				else: return 21.700000000000003
			elif obj[5]<=6.217747899159664:
		...
		elif obj[12]>14.181904761904761:
